package org.king2.aoppractice.entity.vo;
...
public class SystemResultVo implements Serializable {
    ...
    public static SystemResultVo ok(Object object){
        return new SystemResultVo(SystemResultCodeEnum.SUCCESS.CODE,SystemResultCodeEnum.SUCCESS.MESS,object);
    }
     ...
     * @return
     */
    public static SystemResultVo error(Object object){
        return new SystemResultVo(SystemResultCodeEnum.ERROR.CODE,SystemResultCodeEnum.ERROR.MESS,object);
    }
